...
public class CoopReportType implements Serializable {
	...
	public CoopReportType(Integer reportTypeCode, String reportType, String reportDesc) {
		this.reportTypeCode = reportTypeCode;
	...
	public String toString() {
		return "science.aperture.glados.CoopReportType[ reportTypeCode=" + reportTypeCode + " ]";
	}
